...
.run(['taRegisterTool', '$window', 'taTranslations', 'taSelection', function(taRegisterTool, $window, taTranslations, taSelection){
	...
	taRegisterTool('wordcount', {
		...
		activeState: function(){ // this fires on keyup
            ...
            sourceText = sourceText.replace(/(&#160;|&nbsp;)/g, ' '); // replace non breaking space
            sourceText = sourceText.replace(/\s+/g,' '); // remove duplicate spaces

			// Caculate number of words
			var sourceTextMatches = sourceText.split(' '); // split on spaces
            sourceTextMatches = sourceTextMatches.filter(function(e){return e;}); // filter empty strings
